...
return d}function count_bs_days(t,r){var s=t.split("/"),i=r.split("/"),e=+s[2],f=+s[0],l=+s[1],n=+i[2],o=+i[0],u=+i[1];let a=0;if(n<e||n===e&&o<f||n===e&&o===f&&u<l)return 0;for(let t=f-1;t<12&&!(e===n&&t>=o-1);t++)a+=this.bs[e][t];a-=l;for(let t=e+1;t<n;t++)a+=arraySum(this.bs[t]);if(n>e)for(let t=0;t<o-1;t++)a+=this.bs[n][t];return a+=u,a}function add_ad_days(t,e){var n=new Date(t)
